...
DigitalOcean provides a sample ASP.NET application you can deploy to App Platform. You can deploy the app without modification, or add it to your GitHub account so that you can customize it and use automatic redeployments when you make changes.
...
To customize the app or use automatic redeployments, click the **Git source** link **[digitalocean/sample-aspnet](https://github.com/digitalocean/sample-aspnet)**. When the GitHub repo opens, click the **Fork** button in the upper right, and then follow the on-screen instructions. To learn more about forking repos, see the [GitHub documentation](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo).

After forking the repo, you can view the same README in your own GitHub org, for example, at `https://github.com/<your-org>/sample-aspnet`.
